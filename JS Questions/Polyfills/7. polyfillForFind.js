...
if (!Array.prototype.findPolyfill) {
  Array.prototype.findPolyfill = function (callbackFn, thisArg) {
    if (this == null || this === window)
    {
      throw TypeError('Array.prototype.findPolyfill called on null or undefined');
    }
...
console.log(result2)                     // 865

// let result3 = arr1.find(function func2(item, index){
//   console.log(this)
//   return (500<item && item<900)
// })
// console.log(result3)