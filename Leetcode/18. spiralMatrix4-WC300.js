...
// presented in spiral order (clockwise), starting from the 
// top-left of the matrix. If there are remaining empty spaces, 
// fill them with -1.
...
let inputlinkedListArr = [3,0,2,6,8,1,7,9,4,2,5,5,0]
let head = {}
let currentHead = head;
while(inputlinkedListArr.length>0)
{
    currentHead.val = inputlinkedListArr.shift()
    if(inputlinkedListArr.length>0)
    {
        currentHead.next = {}
