...
// of leftover integers in nums after doing the operation as 
...
var numberOfPairs = function(nums) {
    let totalCount = 0, arrLength = nums.length;
    ...
    return [totalCount,arrLength-2*totalCount]
