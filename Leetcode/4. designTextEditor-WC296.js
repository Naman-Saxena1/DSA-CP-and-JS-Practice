...
TextEditor.prototype.deleteText = function(k) {
    let n = this.leftText.length
    if(n <= k){
        this.pos = 0
        this.leftText = ''
        return n                        // return numbers of characters deleted
    }else{
        this.pos = n - k
        this.leftText = this.leftText.substring(0, this.pos)
        return k
    }
};
...
TextEditor.prototype.cursorLeft = function(k) {
    ...
    this.rightText = this.leftText.substring(this.pos) + this.rightText
    this.leftText = this.leftText.substring(0, this.pos)
    
    let len = Math.min(10, this.leftText.length)
    return this.leftText.substring(this.pos - len)
};
...
TextEditor.prototype.cursorRight = function(k) {
    this.pos = (this.pos + k) >= (this.leftText.length + this.rightText.length) 
               ? (this.leftText.length + this.rightText.length) : this.pos + k
    
    this.leftText = this.leftText + this.rightText.substring(0, k)
...
var obj = new TextEditor()
console.log(obj)                             // TextEditor { pos:  0, leftText:              '', rightText: '' }
obj.addText("leetcode");                     // TextEditor { pos:  8, leftText:     'leetcode|', rightText: '' }
obj.deleteText(4);                           // TextEditor { pos:  4, leftText:         'leet|', rightText: '' }
obj.addText("practice");                     // TextEditor { pos: 12, leftText: 'leetpractice|', rightText: '' }
obj.cursorRight(3); // return 'etpractice'   // TextEditor { pos: 12, leftText: 'leetpractice|', rightText: '' }
obj.cursorLeft(8);  // return 'leet'         // TextEditor { pos:  4, leftText:         'leet|', rightText: 'practice' }
